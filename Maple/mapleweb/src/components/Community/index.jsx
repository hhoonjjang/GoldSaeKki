        ...
        <AllBox className="allBox">
          <ContentBox className="contentBox">
            ...
            <Routes>
              ...
              <Route path="/Free" element={<ListContainer categorys={CATEGORY} category={"자유게시판"} />}></Route>
              <Route path="/Information" element={<ListContainer category={"정보게시판"} />}></Route>

              {/* 이놈들은 UI가 달라서 새로운 컴포넌트 만들어야함 : 일단 안 만듦 */}
              <Route path="/TopicDiscussion" element={<ListContainer category={"토론게시판"} />}></Route>
              <Route path="/Art" element={<ListContainer category={"금쪽이아트"} />}></Route>
              <Route path="/Coordination" element={<ListContainer category={"금쪽이코디"} />}></Route>
