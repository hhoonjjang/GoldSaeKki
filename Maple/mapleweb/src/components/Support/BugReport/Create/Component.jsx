      ...
      <CreateBox>
            ...
            <tr>
              ...
              <td>
                <CKEditor
                  ...
                  data="<p><불법프로그램 신고><div>&nbsp;</div>
                  1. 어떤 불법프로그램인가요? 이 불법프로그램을 사용하면 어떻게 되나요?
                  <p>&nbsp;</p>
                  2. 이 불법프로그램을 언제, 어디서 얻게 됐나요? 인터넷으로 얻었다면 그 사이트는 어디인가요?
                  <p>&nbsp;</p>

                  3. 가지고 있는 불법프로그램은 첨부 '파일첨부' 기능을 사용해서 추가해주세요.
                  <p>&nbsp;</p>
        ...
        <div className="describe">
          ...
          <div>
            <ul>
              <li>
                메이플스토리와 함께 사용해도 된다고 공식 안내하지 않았지만 함께
                사용했을 때 게임에 영향을 주는 모든 프로그램에 대해서 제보 부탁
                드립니다.
                <ul>
                  <li className="dash">
              ...
              <li>
                불법프로그램신고로 제보하실 때에는 불법프로그램을 어떻게 얻었고,
                어떤 효과를 얻는 지 알 수 있도록 구체적인 내용을 적어
                신고합니다.
              </li>
              <li>
                불법프로그램 파일은 반드시 압축해서 첨부해주시기 바랍니다.(첨부
                가능한 파일 확장자는 zip, alz, egg, 7z, rar입니다.)
              </li>
              <li>
                파일의 용량이 크다면 분할압축을 해서 모든 파일을 첨부할 수 있을
                때까지 여러 번 신고해 주시기 바랍니다.
              </li>
            </ul>
          </div>
        </div>
