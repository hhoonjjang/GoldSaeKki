...
| 개인 |                                   **헤더 제작 및, 연결, 라우팅**                                    | 2022.12.09 ~ 2022.12.12.  |
| 개인 |                                      **메인 페이지 UI, 헤더**                                       | 2022.12.13. ~ 2022.12.14. |
| 개인 |                                   **메인 페이지 UI 로그인 섹션**                                    |        2022.12.15.        |
| 개인 |                          **메인 페이지 UI 커뮤니티 섹션 및 공지사항 섹션**                          |        2022.12.16.        |
| 개인 |                                 **메인 페이지 UI 로그인 유저 섹션**                                 |        2022.12.19.        |
| 개인 |                                  **메인 페이지 Carousel, Header**                                   |        2022.12.20.        |
| 개인 |                           **메인 페이지 Carousel, 커뮤니티 섹션, Server**                           |        2022.12.21.        |
| 개인 |                               **메인 페이지 Carousel, 커뮤니티 섹션**                               | 2022.12.22 ~ 2022.12.23.  |
| 개인 |                                   **메인 페이지 검색 기능 추가**                                    |        2022.12.23.        |
| 개인 |                                  **메인 페이지 랭킹 섹션, 반응형**                                  | 2022.12.26. ~ 2022.12.27  |
| 개인 |                                 **메인 페이지, 검색 페이지 반응형**                                 |        2022.12.27.        |
| 개인 |                            **메인 페이지, 검색 페이지 반응형 및 라우팅**                            |        2022.12.28.        |
| 개인 |                                  **검색 페이지 재검색 기능 추가**                                   |        2022.12.29.        |
...
> 5. AWS 환경에서 메인 페이지의 커뮤니티 섹션에서 게시판 글을 조회하지 못하는 문제가 발생하였다.

        => 우분투 서버 환경에서는 작동하지 않는 SQL문으로 배열을 불러오려 하였기에 반환값이 없어 undefined가 반환되기에 발생하는 문제였다.
        try catch 문으로 에러 발생 시 빈 배열을 넣는 것으로 에러가 발생하지 않게 하였고, group by로 묶지 않고 여러 번 통신하는 것으로 대체하여 해결하였다.
