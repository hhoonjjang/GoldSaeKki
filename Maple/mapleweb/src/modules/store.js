...
import { initialize as categoryIni, reducer as categoryReducer } from "./community";
...
const store = createStore(
  ...
  { regist: registIni, report: reportIni, header: headerIni, user: userIni, category: categoryIni },
